...
const page = () => {
	...
	const { register: registerFn, loading } = useAuth();
		...
		<div className="min-h-screen bg-gray-900 flex items-center justify-center px-4 sm:px-6 lg:px-8">
			<div className="max-w-md w-full">
				<div className="text-center mb-8">
					...
					>
						<Image src={"/logo.png"} alt="Drawlio" width={50} height={50} />
				...
				<div className="bg-gray-800 rounded-2xl shadow-xl shadow-cyan-500/10 border border-gray-700 p-8">
					<form onSubmit={handleSubmit(registerFn)} className="space-y-6">
						<div>
						...
						<button
							type="submit"
							disabled={loading}
							className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 text-white py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-cyan-500/25 transform hover:scale-105 transition-all duration-200 flex items-center justify-center space-x-2 cursor-pointer"
						>
							{loading ? (
