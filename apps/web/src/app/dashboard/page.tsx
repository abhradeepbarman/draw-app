        ...
        <div className="min-h-screen bg-gray-900">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex items-center space-x-2">
                                <div className="w-6 h-6 bg-gradient-to-br from-cyan-400 to-purple-500 rounded"></div>
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent w-80"
                                />
                                <kbd className="absolute right-3 top-1/2 transform -translate-y-1/2 text-xs text-gray-400 bg-gray-600 px-1.5 py-0.5 rounded">
                                    Ctrl K
                                </kbd>
                            </div>
            ...
            <div className="flex">
                ...
                <main className="flex-1 p-6">
                    ...
                    {/* Empty State */}
                    {filteredDrawings.length === 0 && searchQuery && (
